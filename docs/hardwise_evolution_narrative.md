...
公开 demo 的当前口径是 25 components、17 validated rows、BOM matched=25、PASS/WARN/ERROR=5/9/3、8 manual rows。这里要特别说明：17 个 L1 rows 里，4 个是 profile-backed targets，13 个是 generic passive checks。generic passive 是 light deterministic coverage，不等于深度 datasheet review。
