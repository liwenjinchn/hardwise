...
from hardwise.report.ui_terms import validation_summary_label
...
# Internal builders remain importable here for compatibility.
from hardwise.report.validator_multi_ui_content import (  # noqa: E402
    _basic_info_content,
    _compliance_content,
    _connectivity_content,
    _evidence_content,
    _model_check_content,
    _pin_consistency_content,
    _pin_feed_content,
    _scope_content,
    _summary_content,
    _topology_content,
)
from hardwise.report.validator_multi_ui_profile import (  # noqa: E402
    _check_subject,
    _profile_evidence_table,
    _profile_fact_table,
    _profile_fact_table_with_gaps,  # noqa: F401
    _profile_meta,
    _profile_part_cell,
